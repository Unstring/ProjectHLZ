...
export default function App() {
  ...
  const [url, setUrl] = useState("https://copyhlzglobalregistration-production.up.railway.app/v1/attendance/japa/present?date=" + getTodayDateInFormat());
          ...
          <div className="-m-1.5 overflow-x-auto">
            <div className="p-1.5 min-w-full inline-block align-middle">
              <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden dark:bg-slate-900 dark:border-gray-700">
                {/* Header */}
                <TableHeader fetchData={fetchData} setUrl ={setUrl} url = {url} setData={setData} />
                {/* End Header */}
                {/* Table */}
